...
train_and_predict_dataset <- fread("/data/ltao/Qiu_paper/data_for_reconstruction_by_sector/train_and_predict_dataset_Transportation_0806.csv")
...
param_table <- fread("/data/ltao/Qiu_paper/data_for_reconstruction_by_sector/param_table_transportation.csv")
...
fwrite(out.data.all, "/data/ltao/Qiu_paper/data_for_reconstruction_by_sector/merged_all_new_transportation_0807.csv")
