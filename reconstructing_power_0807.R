...
train_and_predict_dataset <- fread("/data/ltao/Qiu_paper/data_for_reconstruction_by_sector/train_and_predict_dataset_Power_0806.csv")
...
param_table <- fread("/data/ltao/Qiu_paper/data_for_reconstruction_by_sector/param_table_power.csv")
...
fwrite(out.data.all, "/data/ltao/Qiu_paper/data_for_reconstruction_by_sector/merged_all_new_power_0807.csv")
