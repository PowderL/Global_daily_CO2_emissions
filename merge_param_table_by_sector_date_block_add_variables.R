#
library(data.table)
parm_opt_dir <- "/data/ltao/Qiu_paper/data_for_reconstruction_by_sector/parm_opt_1229_date_block_add_variables"
...
fwrite(params_table, "/data/ltao/Qiu_paper/data_for_reconstruction_by_sector/param_table_power_1229_date_block_add_variables.csv")
...
params_table[country %in% c("China", "United States", "Germany", "Italy", "Japan", "Russian Federation"), ]
mean(params_table[country %in% c("China", "United States", "Germany", "Italy", "Japan", "Russian Federation", "United Kingdom", "India", "Brazil", "EU", "Spain", "France", "ROW")]$r2)
fwrite(params_table, "/data/ltao/Qiu_paper/data_for_reconstruction_by_sector/param_table_industry_1229_date_block_add_variables.csv")
...
params_table[country %in% c("United Kingdom", "India", "Brazil", "EU", "Spain", "France", "ROW")]
mean(params_table[country %in% c("China", "United States", "Germany", "Italy", "Japan", "Russian Federation", "United Kingdom", "India", "Brazil", "EU", "Spain", "France", "ROW"), ]$r2)
fwrite(params_table, "/data/ltao/Qiu_paper/data_for_reconstruction_by_sector/param_table_transportation_1229_date_block_add_variables.csv")
